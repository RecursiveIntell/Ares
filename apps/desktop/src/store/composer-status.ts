...
import { isSessionGone, isSessionGoneError, markSessionGone, resetSessionGone } from './session-gone'
...
// The public names remain stable for existing callers/tests; ownership of the
// latch is shared with goals/prompts so every session-scoped poll obeys the same
// terminal 4001 boundary.
export const isSessionGoneForBackgroundPolling = isSessionGoneError
export const resetBackgroundPollingGuard = resetSessionGone
