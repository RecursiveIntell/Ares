...
def run_gateway(verbose: int = 0, quiet: bool = False, replace: bool = False, force: bool = False):
    ...
    # Ares owns its isolated release-pointer unit and promotes it atomically; never let the
    # generic Hermes service writer replace that launcher from inside the managed runtime.
